...
import pickle
from .sync import millisec_to_timestamp, sync_stream, load_mocap_csv_timestamp, load_mocap_csv
...
class RealWorldDataset(Dataset):
    ...
    def __init__(
        ...
        for i in range(self.num_demos):
            ...
            for cam_id in cam_ids:
                ...
                # # ! calib removed, use customized calib
    ...
    def __getitem__(self, index):
        ...
        if timestamp not in self.projectors:
            ...
            self.projectors[timestamp] = Projector(os.path.join(CALIB_FILEDIR, timestamp),fortrain=True)
